...
O Arkadice funciona no sistema de Duplos Polos, ou seja, um mesmo atributo representa duas vertentes de como executar a ação. O **narrador** decide qual polo se aplica baseado em como o jogador descreve a ação.
Ex: "Eu convenço o guarda com um sorriso falso" = *Presença (Liderança)*. "Ameaço cortar o braço dele se ele não ceder" = *Presença (Tirania)*.
...
!!! warning "A Dificuldade da Mente Divina"
